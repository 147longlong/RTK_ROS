...
extern prcopt_t* prcopt_exchange;
...
extern void gnss_stream_publish(const unsigned char *stream, int len, int channel);
extern void gnss_stream_subscribe(unsigned char *stream, int* len, int channel);
extern int is_post_proc(void);
extern int is_data_avail(int channel);
extern void rtksol_publish(sol_t *sol);
extern void ros_info(char* info);
